...
class _RegisterState extends StateMVC<Register> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Theme(
        data: ThemeData(
            primaryColor: Theme.of(context).accentColor, buttonColor: Theme.of(context).accentColor, canvasColor: Theme.of(context).primaryColor),
        child: Container(
          height: height,
              ...
              child: Container(
                ...
                child: Column(children: <Widget>[
                  ListTile(
                    ...
                    title: Text('Register', style: Theme.of(context).textTheme.headline4),
                    leading: Icon(
                  ...
                  Padding(
                      padding: EdgeInsets.only(left: MediaQuery.of(context).size.width * 0.02, bottom: MediaQuery.of(context).size.height * 0.09),
                      child: Container()),
                  Expanded(
                                ...
                                InkWell(
                                  onTap: () async {
                                    LocationResult result = await showLocationPicker(
                                      ...
                                      context,
                                      'AIzaSyBDdSVUU-QiUNWLN2VVrI6kmo5DCMQ5xUA',
