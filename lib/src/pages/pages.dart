...
class _PagesTestWidgetState extends State<PagesTestWidget>  with AfterLayoutMixin<PagesTestWidget>{
  ...
  void afterFirstLayout(BuildContext context) async {
    ...
    if (currentUser.value.apiToken != null) {
      FirebaseFirestore.instance.collection("orderDetails").where("driverId", isEqualTo: currentUser.value.id).
         where("status", isEqualTo: 'Shipped')
        .where("driverStatus", isEqualTo: 'Waiting').snapshots().listen((snapshot) {
