                    ...
                    child: Row(
                      ...
                      children: <Widget>[
                        ...
                        Column(
                          ...
                          children: <Widget>[
                            Text(S.of(context).total, style: Theme.of(context).textTheme.headline4),
                            Text(
                    ...
                    children: <Widget>[
                      Row(
                        children: <Widget>[
                          ...
                          Text(' ${Helper.pricePrint(_con.orderData.grand_total)}', style: Theme.of(context).textTheme.headline6)
                        ],
                      ),
                      SizedBox(height: 20),
                      SizedBox(
                        ...
                        child: FlatButton(
                            ...
                            color: _con.orderData.delivery_state == 'delivered' ? Colors.grey : Theme.of(context).accentColor,
                            shape: StadiumBorder(),
                            child: Wrap(children:[
                              ...
                              _con.orderData.delivery_state == 'Accepted'
                                ...
                                textAlign: TextAlign.start,
                                style: TextStyle(color: Theme.of(context).primaryColor),
                              ): _con.orderData.delivery_state == 'Start' || _con.orderData.delivery_state == 'Pickuped'  ?Text(
      'Processing',
      textAlign: TextAlign.start,
      style: TextStyle(color: Theme.of(context).primaryColor),
    )
